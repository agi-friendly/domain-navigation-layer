...
2. Read the public docs index.
3. Read the system/maintenance portal only when the task needs authoring, governance, or repository-local context rules.
4. Read repository-local context docs when the task depends on path mappings or current-user handoff.
...
- Keep the public docs separate from maintenance docs.
