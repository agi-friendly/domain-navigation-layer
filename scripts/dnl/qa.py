...
Usage:
  ...
  python3 scripts/dnl/qa.py --root . --report .agents/skills/dnl-builder/reports/qa-report.md
  python3 scripts/dnl/qa.py --fail-on all
  python3 scripts/dnl/qa.py --json-summary
  python3 scripts/dnl/qa.py --include docs DNL-system --exclude .git node_modules
"""
